...
H = Herbie("2014-08-02 00:00", model="urma", save_dir=PATH_TO_DOWNLOAD_TO, verbose=True)
H.download()
#%%
...
IDX_MIN_LON, IDX_MIN_LAT = FindIndicesOfSpecificPoint(MIN_LAT-0.5, MIN_LON+0.2, model='urma')
